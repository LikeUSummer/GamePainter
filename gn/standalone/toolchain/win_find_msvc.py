...
def main():
    ...
    versions = [2022, 2019, 2017, 2015, 2013, 2008]
    variants = ['BuildTools', 'Community', 'Professional', 'Preview']
    for version in versions:
        for variant in variants:
            msvc_base = ('C:\\Program Files\\Microsoft Visual Studio\\{}\\'
                        '{}\\VC\\Tools\\MSVC').format(version, variant)
